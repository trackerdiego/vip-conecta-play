...
import { MapPin, Navigation, ExternalLink, Package, ChevronUp, ChevronDown } from 'lucide-react';
...
export function ActiveDeliverySheet({
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-16 z-[1000] transition-all duration-300 ease-in-out"
